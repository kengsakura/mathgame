/**
 * Seed script: สร้างโจทย์อนุกรมเลขคณิต (ง่าย) 50 ข้อ แล้ว insert ลง Supabase
 * Usage: npx tsx scripts/seed-arithmetic-series.ts
 */
...
async function seed() {
  const questions = generator.generateQuestions(50, {
    difficulty: 'easy',
    maxConstantTerm: 20,
    questionType: 'arithmetic_series',
  })
  ...
  console.log(`\nเสร็จ! เพิ่มโจทย์อนุกรมเลขคณิต (ง่าย) ${rows.length} ข้อเรียบร้อย`)
}
